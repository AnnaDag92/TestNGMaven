...
public class XMLParsing {
    ...
    public static Object[][] getTestData(String filePath) {
        try {
            ...
            Object[][] testData = new Object[testDataCount][3];
            ...
            for (int i = 0; i < testDataCount; i++) {
                ...
                if (testNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String password = testElement.getElementsByTagName("parameter")
                            ...
                            .getNamedItem("value")
                            .getTextContent();
                    String valid = testElement.getElementsByTagName("parameter")
                            .item(2)
                            .getAttributes()
                            .getNamedItem("value")
                            .getTextContent();
    ...
    public Object[][] getLoginData() {
        return getTestData("C:/Users/AnnaD/IdeaProjects/TestNGMaven/src/main/java/TestNG/testng.xml");
    }
}
